...
const _monitoringQuestion: QuestionTree = {
    ...
    options: [
      { label: "None", value: "none", nextQuestion: outputDirQuestion, default: true },
      { label: "Splunk", value: "splunk", nextQuestion: outputDirQuestion },
      { label: "ELK", value: "elk", nextQuestion: outputDirQuestion }
    ]
};
